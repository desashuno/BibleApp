...
/**
 * Handles morphology data module installation.
 */
internal class MorphologyModuleHandler : DataModuleHandler {
    override val supportedType: DataModuleType = DataModuleType.Morphology
