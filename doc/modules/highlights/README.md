...
> Module documentation for **Highlights** in BibleStudio.

---

## 1. Overview

<!-- Inline highlights in the reader with character-level selection, customizable color palettes, highlight filtering and searching. -->
...
| Aspect | Status |
|---------|--------|
| SQLite Schema | Definido (schema ready) |
| Component(s) | Partial |
| UI / Pane | Partial |
| Tests | Partial |
| i18n | Partial (EN/ES) |
