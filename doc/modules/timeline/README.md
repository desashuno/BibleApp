...
> Module documentation for **Timeline** in BibleStudio.

---

## 1. Overview

<!-- Interactive timeline with biblical events, temporal navigation, Knowledge Graph integration. -->
