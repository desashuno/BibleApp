...
> Module documentation for **Module System** in BibleStudio.

---

## 1. Overview

<!-- Module system with version checking, auto-update, biblical data package management. -->
...
| Field | Value |
|-------|-------|
| **PaneType** | `PaneType.moduleSystem` |
| **Category** | Tools |
...
| Module | Dependency type | Description |
|--------|-------------------|-------------|
| <!-- All modules that use biblical data depend on this to obtain data packages --> | | |
